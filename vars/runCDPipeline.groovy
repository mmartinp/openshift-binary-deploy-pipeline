        ...
        stages {
            ...
            stage("Deploy UAT") {
                steps {
                    ...
                    applyTemplate(project: env.UAT_PROJECT, 
                                  application: env.APP_NAME, 
                                  template: env.APP_TEMPLATE, 
                                  parameters: env.APP_TEMPLATE_PARAMETERS_UAT,
                                  replaceConfig: env.APP_REPLACE_CONFIG_UAT,
                                  deploymentPatch: env.APP_DEPLOYMENT_PATCH_UAT)

                    tagImage(srcProject: env.DEV_PROJECT, 
                             srcImage: env.IMAGE_NAME, 
                             srcTag: env.TAG_NAME, 
                             dstProject: env.UAT_PROJECT, 
                             dstImage: env.IMAGE_NAME,
                             dstTag: env.TAG_NAME)
                    
                    deployImage(project: env.UAT_PROJECT, 
                                application: env.APP_NAME, 
                                image: env.IMAGE_NAME, 
                                tag: env.TAG_NAME)
                }
